...
// This file is used when running: ng serve / ng build
// For production builds, environment.prod.ts is substituted automatically via angular.json fileReplacements.
export const environment = {
  ...
  firebase: {
    ...
    appCheckSiteKey: '6LcydzYtAAAAAGlFdpxobCtjYYXSpA_aUXCsVIz5'
  }
};
